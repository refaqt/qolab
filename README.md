...
- [docs/governance.md](docs/governance.md) — how decisions are made: circles, consent, escalation ladder, hour acceptance
...
- [token-system-design/paths/governance-voting/](token-system-design/paths/governance-voting/README.md) — the governance leg: √-count vote-only shares, vote cap, veto share, asset lock ([ADR 2026-09-15](docs/decisions/2026-09-15_votes-off-the-reward.md), Proposed)
