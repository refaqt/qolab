...
5. **Time-opened fee cap** at payout, per contribution **lot**: starts at 1× documented effort; opens toward `k × effort` only while that lot’s principal is unpaid; freezes once 1× is paid. Record date and formula: [ADR 2026-09-03 time-opened fee cap](2026-09-03_time-opened-fee-cap.md). Returns can exceed the hourly notional but not on a short payback, and not without bound.
