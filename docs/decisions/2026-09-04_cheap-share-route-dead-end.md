...
- Inbreng in nijverheid, done honestly, is a share-valuation event — often worse than a contingent fee — not a shelter. Using it to reward **later** unplanned work is a **dead-end** on process as well ([ADR 2026-09-10](2026-09-10_inbreng-in-nijverheid-dead-end.md)).
