...
| `token-system-design/` | Bonding-curve draft, spreadsheets, Belgian tax/legal analysis, parked vintage note, accepted `p` burn against remaining cap, cheap-share and bonding-curve-shares dead-ends |
