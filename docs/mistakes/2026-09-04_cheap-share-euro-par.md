...
Do not issue extra profit-sharing shares whose number is set by contribution points, including at a €1 ticket price, at €0.10 vs €10 investor shares, **when there are no investors yet**, or as an **informal** “we’ll put it on paper later” ledger. Do not give `p` a euro par (cap, burn, or conversion rate). Keep the governance share off the reward. A points-minted right is a fee story (option 2) or it will be recharacterised as one; dressing it as a dividend does not win option 1.
