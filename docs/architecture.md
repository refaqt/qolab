...
- Nested mint budgets for sub-projects (**accepted** mint gate): [token-system-design/nested-mint-budgets.md](../token-system-design/nested-mint-budgets.md), [ADR 2026-09-08](decisions/2026-09-08_nested-mint-budgets.md). Open fork on how nested `p_j` sunsets / whether the sub-project takes euros: [docs/log/2026-09-08_nested-p-sunset-two-directions.md](log/2026-09-08_nested-p-sunset-two-directions.md) (next pass: project-as-contractor).
