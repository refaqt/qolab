...
| Capped participating bond + two-leg waterfall (hardware for experiments: bond, then company purchase, then loan for use) | **Open (proposed)** ([ADR 2026-09-14](decisions/2026-09-14_investor-leg-capped-participating-bond.md), [ADR 2026-09-14 hardware](decisions/2026-09-14_hardware-via-bond-and-loan.md)) | [paths/capped-participating-bond/](../token-system-design/paths/capped-participating-bond/README.md) |
| Governance leg — √-count vote-only shares at €1, vote cap, class G veto share, asset lock (pays nobody; investors stay on the bond with no vote) | **Open (proposed)** ([ADR 2026-09-15](decisions/2026-09-15_votes-off-the-reward.md)) | [paths/governance-voting/](../token-system-design/paths/governance-voting/README.md); operating model in [governance.md](governance.md) |
...
| `docs/governance.md` | Operating model: circles, consent, escalation ladder, decision rights, hour acceptance |
