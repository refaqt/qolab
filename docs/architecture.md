...
- Tokens instead of shares to skip the inbreng-revisor (**open** for **contracts**, not live spec): phantom / revenue-share / profit-share contracts vs NV *winstbewijzen*; arm’s length; warrants; 10× of labour is not a dividend FPS will ignore — two instruments (fee + cash shares) or gated option-2 10× — [docs/log/2026-09-10_tokens-not-shares-avoid-revisor.md](log/2026-09-10_tokens-not-shares-avoid-revisor.md). The nijverheid **share** path is closed.
...
- Cheap-share route (**dead-end**): [token-system-design/cheap-share-route.md](../token-system-design/cheap-share-route.md). A 2026-09-08 variant (€0.10 vs €10, quota = `f(p)`, no burn) is the same rejection: [docs/log/2026-09-08_option-1-tenth-vs-ten-euro-shares.md](log/2026-09-08_option-1-tenth-vs-ten-euro-shares.md). 2026-09-10 variants (no investors / informal; MoU → unpaid / “given” / revalued class if `N = f(work)`) are the same rejection: [docs/log/2026-09-10_no-investors-euro-shares.md](log/2026-09-10_no-investors-euro-shares.md), [docs/log/2026-09-10_startup-equity-mou.md](log/2026-09-10_startup-equity-mou.md). A 2026-09-11 variant (linear `p = c/1000` quota, €1 A / €100 B with dividend per share, ± a 10-year sunset) is the same rejection: [docs/log/2026-09-11_cheap-share-ab-classes-sunset.md](log/2026-09-11_cheap-share-ab-classes-sunset.md)
...
- Inbreng in nijverheid as later reward without a plan-ahead commitment (**dead-end**): [docs/log/2026-09-10_inbreng-in-nijverheid-dead-end.md](log/2026-09-10_inbreng-in-nijverheid-dead-end.md), [ADR 2026-09-10](decisions/2026-09-10_inbreng-in-nijverheid-dead-end.md)
